...
//class which implements the currency abstract class as a concrete neptune class to keep track of what neptune's currency is and what their total funds are
public class Neptune extends Currency {

  //contructor which sets the currencyname string from the extended currency class and totalfunds double to their respective amounts when a new instance of neptune is made
	public Neptune(double amount) {
    currencyName = "NeptuneNuggets";
    totalFunds = amount;
	}

  //implementation of the double to earth dollars which takes the amount and divides it by the exchange rate of neptunenuggets
  @Override
	public double toEarthDollars(double amount) {
		return amount/NN;
	}

  //implementation of the double from earth dollars which takes the amount in earth dollars and multiplies it by the exchange rate of neptunenuggets
  @Override
