...
//class which implements the currency abstract class as a concrete saturn class to keep track of what saturn's currency is and what their total funds are
public class Saturn extends Currency {

  //contructor which sets the currencyname string from the extended currency class and totalfunds double to their respective amounts when a new instance of saturn is made
	public Saturn(double amount) {
    currencyName = "SaturnSilver";
    totalFunds = amount;
	}

  //implementation of the double to earth dollars which takes the amount and divides it by the exchange rate of saturnsilver
  @Override
	public double toEarthDollars(double amount) {
		return amount/SS;
	}

  //implementation of the double from earth dollars which takes the amount in earth dollars and multiplies it by the exchange rate of saturnsilver
  @Override
